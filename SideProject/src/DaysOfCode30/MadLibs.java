...
// Getters and Setters
    ...
    public void printInstruction() {
        System.out.println("Wellcom to the MadLibs game. If you type in"
                + "words, we`ll give you a story. Start by typing in your name.");
    }
    ...
    public void putTogetherTheStory() {
        ...
        if (num == 0) {
            story = "Jasse and her best friend " + getName() + "went to Disney World today!"
                    + "They saw a " + getNoun1() + "in a shwo at the Magic Kingdom"
            ...
            story = "Amanda and her frenemy " + getName() + "went to the zoo last summer."
                    ...
                    + "they decide to climb " + getAdverb() + "into the " + getNoun3() + "to get a closer look"
                    + "The zoo was " + getAdjective1() + " at night, but they didn`t care... "
                    + "until" + getRandomNums() + " " + getAdjective2() + " apes yelld in their faces, making "
